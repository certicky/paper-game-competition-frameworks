...
\thanks{Michal \v{C}ertick\'{y}, Jan~Mal\'{y} and Michal~\v{S}ustr are with the Artificial Intelligence Center at Faculty of Electrical Engineering, Czech Technical University in Prague. Emails:~\tt{certicky@agents.fel.cvut.cz}, \tt{jan.maly@aic.fel.cvut.cz}, \tt{michal.sustr@gmail.com}}% <-this % stops a space
