...
\author{Michal~\v{C}ertick\'{y}, David~Churchill, Kyung-Joong~Kim, Martin~\v{C}ertick\'{y}, and~Richard~Kelly% <-this % stops a space
\thanks{Michal \v{C}ertick\'{y} is with the Artificial Intelligence Center at Czech Technical University in Prague. Email: {\scriptsize \tt{certicky@agents.fel.cvut.cz}}}% <-this % stops a space
\thanks{David Churchill and Richard Kelly are with Department of Computer Science, Memorial University of Newfoundland. Emails: {\scriptsize\tt{dave.churchill@gmail.com}, \tt{richard.kelly@mun.ca}}}% <-this % stops a space
\thanks{Martin \v{C}ertick\'{y} is with Deptartment of Cybernetics and Artificial Intelligence, Technical University in Ko\v{s}ice. Email: {\scriptsize \tt{martin.certicky@tuke.sk}}}% <-this % stops a space
