...
\thanks{Michal \v{C}ertick\'{y}, Jan~Mal\'{y} and Michal~\v{S}ustr are with the Artificial Intelligence Center at Faculty of Electrical Engineering, Czech Technical University in Prague. Emails: {\scriptsize \tt{certicky@agents.fel.cvut.cz}, \tt{jan.maly@aic.fel.cvut.cz}, \tt{michal.sustr@aic.fel.cvut.cz}}}% <-this % stops a space
