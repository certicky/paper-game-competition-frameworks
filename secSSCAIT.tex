...
\emph{Mixed Division}: After the student division ended, sixteen bots with the most wins among all the participants were selected for the additional “mixed division” double elimination bracket, consisting of 30 matches. 
%Since two bots (Steamhammer and Zia bot) were tied for 16th place, both with 54 wins, a tie-breaker match was scheduled to decide which moved on. 

The following 16 bots played in the mixed division elimination bracket: {\em Iron Bot, ZurZurZur, Microwave, Neo Edmund zerg, Bereaver, ArrakHammer, Steamhammer, Skynet, McRave, AIlien, CherryPi, TyrProtoss, KillerBot, LetaBot, WuliBot} and {\em XIMP}. The matches were played according to ``best of 3'', ``best of 5'' and ``best of 7'' format, depending on the bracket stage. 
%First round (Ro16) matches consisted of only a single game, but Ro8 and Ro4 were played as ``best of 3'' matches. Finals were played as ``best of 5''.\\
