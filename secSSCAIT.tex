...
%Recent release of platform-independent Docker container with pre-installed StarCraft and all the bot requirements~\cite{maly2018multi} might cause additional modifications in the near future.
